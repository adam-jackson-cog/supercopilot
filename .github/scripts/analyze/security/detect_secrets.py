...
class SecretDetector:
                ...
                for pattern_name, pattern_info in self.patterns.items():
                    ...
                    for match in matches:
                        ...
                        finding = {
                            ...
                            "matched_value": secret_value[:20] + "..." if len(secret_value) > 20 else secret_value,
    ...
    def analyze(self, target_path: str) -> 'AnalysisResult':
        ...
        result = ResultFormatter.create_security_result("detect_secrets.py", target_path)
